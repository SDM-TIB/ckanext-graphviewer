...
pub const TYPE_ORGANIZATION: &str = "http://www.w3.org/2006/vcard/ns#Organization";

// Predicates
pub const PRED_CREATOR: &str = "creator";
pub const PRED_LABEL: &str = "label";
pub const PRED_TITLE: &str = "title";
pub const PRED_FN: &str = "fn";
pub const PRED_VCARD_FN: &str = "vcard/ns#fn";
pub const PRED_IS_ROOT: &str = "http://app.local/isRootNode";
